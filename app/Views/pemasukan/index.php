        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (session('level') == 'admin') : ?>
                    ...
                    <a href="<?= base_url(); ?>/admin/pemasukan-excel/<?= $date_encode; ?>" class="btn btn-sm btn-info mb-2"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                    <a href="<?= base_url(); ?>/admin/print-pemasukan/<?= $date_encode; ?>" class="btn btn-sm btn-dark mb-2"><i class="fa fa-file mr-2" aria-hidden="true"></i>Download PDF</a>
                <?php endif; ?>


                <?php if (session('level') == 'manager') : ?>
                    <a href="<?= base_url(); ?>/view/pemasukan-excel/<?= $date_encode; ?>" class="btn btn-sm btn-info mb-2"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                    <a href="<?= base_url(); ?>/view/print-pemasukan/<?= $date_encode; ?>" class="btn btn-sm btn-dark mb-2"><i class="fa fa-file mr-2" aria-hidden="true"></i>Download PDF</a>
                <?php endif; ?>
                <div class="card mb-4">
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>Grand Total :</th>
                                        <th><?= 'Rp. ' . number_format($grand_total_store, 2, ',', '.')  ?></th>
                                        <th><?= 'Rp. ' . number_format($grand_total_design, 2, ',', '.')  ?></th>
                                        <th><?= 'Rp. ' . number_format($grand_total_workshop, 2, ',', '.')  ?></th>
                                        <th><?= 'Rp. ' . number_format($gran_total, 2, ',', '.')  ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
