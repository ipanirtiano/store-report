        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <?php if (session('level') == 'admin') : ?>
                    <a href="<?= base_url(); ?>/admin/profit-excel/<?= $date_encode; ?>" class="btn btn-sm btn-info mb-2"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                    <a href="<?= base_url(); ?>/admin/print-profit/<?= $date_encode; ?>" class="btn btn-sm btn-dark mb-2"><i class="fa fa-file mr-2" aria-hidden="true"></i>Download PDF</a>
                <?php endif; ?>
                <?php if (session('level') == 'manager') : ?>
                    <a href="<?= base_url(); ?>/view/profit-excel/<?= $date_encode; ?>" class="btn btn-sm btn-info mb-2"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                    <a href="<?= base_url(); ?>/view/print-profit/<?= $date_encode; ?>" class="btn btn-sm btn-dark mb-2"><i class="fa fa-file mr-2" aria-hidden="true"></i>Download PDF</a>
                <?php endif; ?>
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr class="bg-light">
                                        ...
                                        <th><?= 'Rp. ' . number_format($jan_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th><?= 'Rp. ' . number_format($feb_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr class="bg-light">
                                        ...
                                        <th><?= 'Rp. ' . number_format($mar_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th><?= 'Rp. ' . number_format($apr_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr class="bg-light">
                                        ...
                                        <th><?= 'Rp. ' . number_format($mei_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th><?= 'Rp. ' . number_format($jun_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr class="bg-light">
                                        ...
                                        <th><?= 'Rp. ' . number_format($jul_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th><?= 'Rp. ' . number_format($aug_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr class="bg-light">
                                        ...
                                        <th><?= 'Rp. ' . number_format($sep_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th><?= 'Rp. ' . number_format($okt_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr class="bg-light">
                                        ...
                                        <th><?= 'Rp. ' . number_format($nov_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                    <tr>
                                        ...
                                        <th><?= 'Rp. ' . number_format($des_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        ?>
                                        <th><?= 'Rp. ' . number_format($tot_pemasukan, 2, ',', '.')  ?></th>
                                        <th><?= 'Rp. ' . number_format($tot_pengeluaran, 2, ',', '.')  ?></th>
                                        <th><?= 'Rp. ' . number_format($tot_profit, 2, ',', '.')  ?></th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
