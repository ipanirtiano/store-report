...
<div id="layoutSidenav_content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col">
                <h1 class="mt-4">Update Data Design</h1>
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-user mr-2" aria-hidden="true"></i> Update Data Penjualan Design
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <form action="<?= base_url(); ?>/design/proses_update/<?= $data_transaksi['kode_transaksi']; ?>" method="post">
                                    <?= csrf_field() ?>
                                    ...
                                    <a href="<?= base_url(); ?>/admin/design/<?= $date_encode; ?>" class="btn btn-sm btn-danger">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
