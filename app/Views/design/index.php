        ...
        <div class="row">
            ...
            <div class="col">
                <?php if (session('level') == 'admin') : ?>
                    ...
                    <a href="<?= base_url(); ?>/admin/design-excel/<?= $date_encode; ?>" class="btn mb-2 btn-sm btn-info"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                <?php endif; ?>
                <?php if (session('level') == 'manager') : ?>
                    <a href="<?= base_url(); ?>/view/design-excel/<?= $date_encode; ?>" class="btn mb-2 btn-sm btn-info"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                <?php endif; ?>

                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-table mr-1"></i>
                        Data Penjualan Design
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <?php if (session('level') == 'admin') : ?>
                                        <form action="<?= base_url(); ?>/admin/design/<?= $date_encode; ?>" method="post">
                                        <?php endif; ?>
                                        <?php if (session('level') == 'manager') : ?>
                                            <form action="<?= base_url(); ?>/view/design/<?= $date_encode; ?>" method="post">
                                            <?php endif ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if (session('level') == 'admin') : ?>
                                                <td class="text-nowrap">
                                                    <a href="<?= base_url(); ?>/admin/edit-design/<?= $data['kode_transaksi']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                                    <a href="<?= base_url(); ?>/admin/hapus-design/<?= $data['kode_transaksi']; ?>" class="btn btn-sm btn-danger tombol-hapus">Hapus</a>
                                                </td>
                                            <?php endif; ?>
                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered 	modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url(); ?>/design/proses_input" method="post">
                        <?= csrf_field() ?>
                        <div class="form-group row">
