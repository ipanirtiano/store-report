                ...
                <div class="row">
                    <div class="col-md-5 mb-1">
                        ...
                        <?php if (session('level') == 'admin') : ?>
                            <a type="button" class="btn btn-sm mt-1 btn-dark mb-2" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Tambah Data</a>
                            <a href="<?= base_url(); ?>/admin/store-excel/<?= $date_encode; ?>" class="btn btn-sm btn-info"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                        <?php endif; ?>
                        <?php if (session('level') == 'manager') : ?>
                            <a href="<?= base_url(); ?>/view/store-excel/<?= $date_encode; ?>" class="btn btn-sm btn-info"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                        <?php endif; ?>
                        ...
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <?php if (session('level') == 'admin') : ?>
                                        <form action="<?= base_url(); ?>/admin/store/<?= $date_encode; ?>" method="post">
                                        <?php endif; ?>
                                        <?php if (session('level') == 'manager') : ?>
                                            <form action="<?= base_url(); ?>/view/store/<?= $date_encode; ?>" method="post">
                                            <?php endif; ?>
                                            <div class="form-group row">
                                                <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label-sm mb-1">Tanggal </label>
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control datepicker mb-1 form-control-sm <?= ($validation->hasError('tanggal') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" name="tanggal" value="<?= ($tanggal_list != NULL ? $tanggal_list : date('d-m-Y')); ?>" autocomplete="off">
                                        ...
                                        <tr>
                                            ...
                                            <?php if (session('level') == 'admin') : ?>
                                                <td class="text-nowrap">
                                                    <a href="<?= base_url(); ?>/admin/edit-store/<?= $data['kode_transaksi']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                                    <a href="<?= base_url(); ?>/admin/hapus-store/<?= $data['kode_transaksi']; ?>" class="btn btn-sm btn-danger tombol-hapus">Hapus</a>
                                                </td>
                                            <?php endif; ?>
                                        </tr>
                                        <?php
        ...
        <div class="modal-dialog modal-dialog-centered 	modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url(); ?>/store/proses_input" method="post">
                        <?= csrf_field() ?>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="colFormLabelSm" class="col-sm-3 col-form-label col-form-label">Nama Barang</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control form-control <?= ($validation->hasError('nama_barang') ? 'is-invalid' : ''); ?>" id="colFormLabelSm" name="nama_barang" value="<?= old('nama_barang'); ?>" placeholder="Nama Barang" onkeyup="this.value = this.value.toUpperCase();">
                                <div class="invalid-feedback" style="font-size: small">
