...
<div id="layoutSidenav_content">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col">
                <button type="button" class="btn mt-1 btn-sm btn-dark mb-3" data-bs-toggle="modal" data-bs-target="#staticBackdrop"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Tambah Data</button>
                <a href="<?= base_url(); ?>/admin/pengeluaran-excel/<?= $date_encode; ?>" class="btn btn-sm btn-info mb-3"><i class="fa fa-file-excel mr-2" aria-hidden="true"></i>Download Excel</a>
                <div class="card mb-4">
                        ...
                        <div class="table-responsive">
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <?php $tanggal = date('d-m-Y'); ?>
                                    <?php $date_encode = base64_encode($tanggal); ?>
                                    <form action="<?= base_url(); ?>/admin/pengeluaran/<?= $date_encode; ?>" method="post">
                                    ...
                                    <?php foreach ($store as $data) : ?>
                                        <tr>
                                            ...
                                            <td class="text-nowrap">
                                                <a href="<?= base_url(); ?>/admin/edit-pengeluaran/<?= $data['kode_transaksi']; ?>" class="btn btn-sm btn-warning">Edit</a>
                                                <a href="<?= base_url(); ?>/admin/hapus-pengeluaran/<?= $data['kode_transaksi']; ?>" class="btn btn-sm btn-danger tombol-hapus">Hapus</a>
                                            </td>
                                        </tr>
                                        <?php
                                        $total += $data['jumlah'];
